"""
Django settings for ordina_movie_review project.
...
SECRET_KEY = 'django-insecure-kb-=1pc!fnf_4-nlmv&^p=$tg(!=_&l@-p($mmsqdmxtx2@99f'
...
AUTH_USER_MODEL = 'moviereviewapp.User'
